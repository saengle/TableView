...
class ShoppingTableViewController: UITableViewController {
    ...
    @IBAction func keyboardInputChanged(_ sender: UITextField) {
        guard let input = addTextField.text else { return }
...
extension ShoppingTableViewController {
    ...
    private func addTarget() {
        self.addButton.addTarget(self, action: #selector(addShoppingList), for: .touchUpInside)
    }
